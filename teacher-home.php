...
<body>
    ...
    <div class="content">
        ...
        <p>Sisteme öğretmen olarak giriş yaptınız. Burada öğretmene özel içerikler yer alacaktır.</p>

        <div class="cards">
            <div class="card" onclick="window.location.href='add-task.php'">Görev Oluştur</div>
            <div class="card">Öğrenci İlerlemesi</div>
            </div>
    </div>
</body>
</html>